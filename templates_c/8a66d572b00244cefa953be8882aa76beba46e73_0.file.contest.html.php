...
?>
        <tr>
		  ...
		  <?php if ($_smarty_tpl->tpl_vars['item']->value['is_private'] == 1) {?>
          <td class="text-center"><a href="check_password.php?cid=<?php echo $_smarty_tpl->tpl_vars['item']->value['contest_id'];?>
